...
<body>
    ...
    <div id="wrapper">
		...
		<div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Chapter 4b: Phishing Email Examples</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
			<div class="panel panel-primary"> 
				<div class="panel-heading"> <h3 class="panel-title">Two Examples</h3> 
				</div> 
				<div class="panel-body">
				<p> The below images will help you understand how Phishing emails will look and how to spot them.</p>
				</br>
				<img src="../pics/phish1.gif">
				</br></br>
				<img src="../pics/phish2.jpg">
				</br>
				</div> 
			</div>
			<ul class="pagination"> 
			...
			<li class="active"><a href="Chapter4b.php">2</a></li> 
