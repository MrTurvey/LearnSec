...
<body>
    ...
    <div id="wrapper">
		...
		<div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Chapter 1b: Password Cracking</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
			<div class="panel panel-primary"> 
				...
				<p>Hackers often attempt to crack passwords. Here is a fun website for showing you how quick you might be cracked.
				Do remember, do not enter your own password, enter a similar password for security. Instead of Password123 use Laptops123</p>
				<h2>https://howsecureismypassword.net/</h2>
				</br>
				<p>These days, passwords can be cracked very fast, which is why a strong password from a password manager is reccomended along with 2FA talked about later.</p>
				<h2>Password Managers</h2>
				<center><iframe width="853" height="480" src="https://www.youtube.com/embed/xHSnHj-zKF4?rel=0&amp;controls=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe></center>
				</div> 
			</div>
			<ul class="pagination"> 
			...
			<li class="active"><a href="Chapter1c.php">3</a></li> 
