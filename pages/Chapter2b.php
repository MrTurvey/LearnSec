...
<body>
    ...
    <div id="wrapper">
		...
		<div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Chapter 2a: Privacy, why care?</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
			<div class="panel panel-primary"> 
				...
				<center><iframe width="853" height="480" src="https://www.youtube.com/embed/85mu9PLWCuI?rel=0&amp;controls=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe></center>
			...
			<li class="active"><a href="Chapter2b.php">2</a></li> 
