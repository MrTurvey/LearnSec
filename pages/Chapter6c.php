...
<body>
    ...
    <div id="wrapper">
		...
		<div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Chapter 6b: Cross Site Request Forgery</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
			<div class="panel panel-primary"> 
				<div class="panel-heading"> <h3 class="panel-title">What is CSRF?</h3> 
				</div> 
				<div class="panel-body">
				<p>Cross Site Request Forgery is a fairly complex flaw to understand, therefore a visual representation 
				helps here:</p>
				 <center><iframe width="853" height="480" src="https://www.youtube.com/embed/MBOMBZS2u-I" frameborder="0" allowfullscreen></iframe></center>
			...
			<li class="active"><a href="Chapter6c.php">3</a></li> 
