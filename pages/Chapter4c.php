...
<body>
    ...
    <div id="wrapper">
		...
		<div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Chapter 4c: Phishing Video</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
			...
			<center><iframe width="853" height="480" src="https://www.youtube.com/embed/9TRR6lHviQc?rel=0&amp;controls=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe></center>
				</div> 
			</div>
			<ul class="pagination"> 
			...
			<li class="active"><a href="Chapter4c.php">3</a></li> 
