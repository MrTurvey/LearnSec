...
<body>
    ...
    <div id="wrapper">
		...
		<div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Chapter 5a: Two Factor Authentication</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
			<div class="panel panel-primary"> 
				<div class="panel-heading"> <h3 class="panel-title">What is 2FA?</h3> 
				</div> 
				<div class="panel-body">
				<p>Two-factor authentication adds a second level of authentication to an account log-in. 
				When you have to enter only your username and one password, that's considered a single-factor authentication. 
				2FA requires the user to have two out of three types of credentials before being able to access an account. 
			...
			<li class="active"><a href="Chapter5.php">1 <span class="sr-only">(current)</span></a></li> 
